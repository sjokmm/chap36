...
<c:choose>
	<c:when test="${param.create ne null}"><h1>해당 직원이 추가되었습니다.</h1></c:when>
	<c:when test="${param.update ne null}"><h1>해당 직원이 수정되었습니다.</h1></c:when>
	<c:when test="${param.delete ne null}"><h1>해당 직원이 삭제되었습니다.</h1></c:when>
