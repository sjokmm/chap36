...
<table class="type09">
  ...
  <tr>
	...
	<menu class="btn-group">
		<a href="/dept/create" class="btn btn-primary" id="c">추가</a>
		<a href="/dept/update?deptno=${dept.deptno}" class="btn btn-secondary" id="u">수정</a>
		<a href="/dept/delete?deptno=${dept.deptno}" class="btn btn-danger" id="d">삭제</a>
	</menu>
	</sec:authorize>
	</div>
</section>
