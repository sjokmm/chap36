...
<section class="container">
	<form action="/dept/create" method="post" id="input">
		<div class="mb-3">
			<label class="form-lable mb-2" for="deptno">부서번호<span>*</span></label>
			<input class="form-control" id="deptno" name="deptno" placeholder="부서번호를 입력하세요." value="${dept.deptno}"/>
		</div>
		<div class="mb-3">
			<label class="form-lable mb-2" for="dname">부서명<span>*</span></label>
			<input class="form-control"    id="dname"  name="dname"  placeholder="부서명을 입력하세요." value="${dept.dname }"/>
		</div>
		<div class="mb-3">
			<label class="form-lable mb-2" for="loc">지역</label>
			<input class="form-control"    id="loc"	   name="loc"    placeholder="지역을 입력하세요." value="${dept.loc}"/>
		</div>
