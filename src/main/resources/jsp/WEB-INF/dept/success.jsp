...
<div class="container text-center text-warning" style="margin-bottom: 100px; font-size: 60pt;">
<c:choose>
	<c:when test="${param.create ne null}"><h1>해당 부서가 추가되었습니다.</h1></c:when>
	<c:when test="${param.update ne null}"><h1>해당 부서가 수정되었습니다.</h1></c:when>
	<c:when test="${param.delete ne null}"><h1>해당 부서가 삭제되었습니다.</h1></c:when>
