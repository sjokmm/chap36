...
<section class="container text-center">
	<table class="table table-striped table-bordered table-hover" id="table_d">
		<thead>
			<tr class="table-dark">
				<th>부서번호</th>
				<th>부서명</th>
		...
		<c:forEach var="e" items="${list}">
			<tr>
				<td><fmt:formatNumber value="${e.deptno}"/></td>
				<td><a href="/dept/detail/${e.deptno}" id="detail">${e.dname}</a></td>
				<td>${e.loc}</td>
			</tr>
		</c:forEach>
		</tbody>
